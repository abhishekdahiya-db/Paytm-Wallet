...
public class KafkaConsumerConfig {
    ...
    @KafkaListener(topics = "TNX-INIT", groupId = "walletApp")
    public void consumeTransactionInitialization(ConsumerRecord payload) throws JsonProcessingException {
        String json = payload.value().toString();
        TransactionStartKafkaObject transactionStartObject = objectMapper.readValue(json, TransactionStartKafkaObject.class);
        walletService.startTransaction(transactionStartObject);
    }
}
